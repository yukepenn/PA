...
def _left_controls(colors: dict, pstyle: dict, lstyle: dict, istyle: dict, bstyle: dict, bprimary: dict, default_date_et: str) -> html.Div:
    return html.Div(
        style=pstyle,
        children=[
...
def _chart_workspace(colors: dict, pstyle: dict, bstyle: dict) -> html.Div:
    return html.Div(
        style=pstyle,
        children=[
            html.Div(
...
def _journal_tab(colors: dict, lstyle: dict, istyle: dict, bstyle: dict, bprimary: dict) -> dcc.Tab:
    return dcc.Tab(
        label="Journal",
        value="journal",
        children=[
...
def _sim_tab(colors: dict, lstyle: dict, istyle: dict, bstyle: dict, bprimary: dict) -> dcc.Tab:
    return dcc.Tab(
        label="Sim",
        value="sim",
        children=[
            html.Div(
                ...
                style={"fontSize": "12px", "color": colors["muted"], "marginTop": "10px", "marginBottom": "10px"},
            ),
...
def _right_panel(colors: dict, pstyle: dict, lstyle: dict, istyle: dict, bstyle: dict, bprimary: dict) -> html.Div:
    return html.Div(
        ...
        children=[
            dcc.Tabs(
                ...
                value="journal",
                children=[
                    _journal_tab(colors, lstyle, istyle, bstyle, bprimary),
                    _sim_tab(colors, lstyle, istyle, bstyle, bprimary),
                ],
            ),
        ],
    )
        ...
        children=[
            *_stores_block(),
            html.Div(
                ...
                children=[
                    _left_controls(colors, pstyle, lstyle, istyle, bstyle, bprimary, default_date_et),
                    _chart_workspace(colors, pstyle, bstyle),
                    _right_panel(colors, pstyle, lstyle, istyle, bstyle, bprimary),
                ],
            )
        ],
    )
